...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_SKIP_WARNINGS,                              "0",         core_options::option_type::BOOLEAN,    "skip displaying the warning screen at startup" },
	{ OPTION_SKIP_LOADINFO,                              "0",         core_options::option_type::BOOLEAN,    "skip displaying the loading / initialising messages at startup" },
